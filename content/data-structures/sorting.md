...
- The `swapped` flag gives the **optimized/adaptive variant**: if a full pass makes no swaps, the array is already sorted $\rightarrow$ early exit $\rightarrow$ `O(n)` best case on already-sorted input.
...
- Worst case `O(n²)` happens on already-sorted or reverse-sorted input with a first-element pivot (each partition is maximally unbalanced). Mitigations not present here but common in production sorts:
  ...
  - Switching to heap sort on bad recursion depth ($\rightarrow$ **introsort**, in the "remaining" list below)
...
<details>
<summary><strong>Comparison Sorts</strong></summary>
...
<details>
<summary><strong>Hybrid Sorts</strong></summary>
...
<details>
<summary><strong>Parallel & Network Sorts</strong></summary>
...
<details>
<summary><strong>External Sorting</strong></summary>
...
<details>
<summary><strong>Cache-Friendly Sorts</strong></summary>
...
<details>
<summary><strong>Linked List Sorting</strong></summary>
...
<details>
<summary><strong>String Sorting</strong></summary>
...
<details>
<summary><strong>Distributed & Big Data Sorting</strong></summary>
...
<details>
<summary><strong>Educational / Joke Sorts</strong></summary>
